...
src_install() {
	...
	fperms 755 "${dir}"/bin/{format.sh,fsnotifier,inspect.sh,ltedit.sh,pycharm.sh,remote-dev-server.sh,jetbrains_client.sh}
	fperms 755 "${dir}"/bin/{pycharm,remote-dev-server,repair,restarter}
